...
export class OrbitSimulation extends LimitedFrameRateCanvas {
    ...
    draw(): void {
        ...
        // Draw orbiter trails and orbiters.
        ctx.globalCompositeOperation = 'lighter';
    ...
    tick(): void {
        ...
        for (const orbiter of this.#orbiters) {
            ...
            // Compute elliptical orbit position with tilt for 3D perspective.
